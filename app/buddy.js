// Shared buddy logic for server-side
const EYES=['·','✦','×','◉','@','°'];
...
export const RARITY_COLORS={common:'#8b949e',uncommon:'#3fb950',rare:'#58a6ff',epic:'#bc8cff',legendary:'#d29922'};
const BODIES={
  duck:[[`            `,`    __      `,`  <({E} )___  `,`   (  ._>   `,`    \`--´    `]],
  goose:[[`            `,`     ({E}>    `,`     ||     `,`   _(__)_   `,`    ^^^^    `]],
  blob:[[`            `,`   .----.   `,`  ( {E}  {E} )  `,`  (      )  `,`   \`----´   `]],
...
export function renderSprite(species,eye,hat){
